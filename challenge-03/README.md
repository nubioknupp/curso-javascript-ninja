...
pessoa.mostrarAltura = function() {
  return "Eu altura " + pessoa.altura + "m.";
}
...
*/
pessoa.nomeCompleto(); // Núbio Knupp
...
*/
pessoa.caminhouQuantosMetros; // 9m
...
pessoa.apresentacao = function() {
  ...
  return "Olá, eu sou o " + nome + ", tenho " + idade + ", " + pessoa.altura + ", meu peso é " +              pessoa.peso + " e, só hoje, eu já caminhei " + caminhou + "!"
}
// Agora, apresente-se ;)
pessoa.apresentacao();
```
